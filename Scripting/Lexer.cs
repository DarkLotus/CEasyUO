...
namespace CEasyUO
{
    public class Lexer
    {
        ...
        public Lexer()
        {
            ...
            _tokens.Add( Tokens.Menu, "menu " );
            _tokens.Add( Tokens.Continue, "continue" );
            _tokens.Add( Tokens.Event, "event " );
            _tokens.Add( Tokens.ExEvent, "exevent " );
            ...
            _tokens.Add( Tokens.Pause, "pause" );
            _tokens.Add( Tokens.LinesPerCycle, "linespercycle" );
            _tokens.Add( Tokens.Click, "click" );
            _tokens.Add( Tokens.Move, "move " );
            _tokens.Add( Tokens.Break, "break" );
            _tokens.Add( Tokens.Tile, "tile " );
            _tokens.Add( Tokens.Target, "target" );
            _tokens.Add( Tokens.Wait, "wait " );
            _tokens.Add( Tokens.IgnoreItem, "ignoreitem " );

            _tokens.Add(Tokens.Scanjournal, "scanjournal " );
            _tokens.Add(Tokens.For, "for ");
            _tokens.Add( Tokens.While, "while " );
            _tokens.Add( Tokens.Abs, "[ \\t]+abs" );
            _tokens.Add( Tokens.If, "if " );
            _tokens.Add( Tokens.In, " in " );
            ...
            _tokens.Add( Tokens.IntLiteral, "[-+]?[0-9]+[s]?" );
            ...
            _tokens.Add( Tokens.StringLiteral, "[a-zA-Z0-9_:']+[a-zA-Z0-9_:']*" );// "[a-zA-Z_:'][a-zA-Z0-9_:']*" );
            _tokens.Add( Tokens.Whitespace, "[ \\t]+" );
            _tokens.Add( Tokens.NewLine, "\\r?\\n" );
        ...
        public Token GetToken()
        {
            ...
            _index++;
            return new Token( Tokens.Undefined, _inputString.Substring(_index-1,_inputString.Length - _index) );
        }
